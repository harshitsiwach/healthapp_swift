...
struct RootView: View {
    ...
    private func updateStreak() {
        ...
        // Already updated today — prevent multi-increment on re-render
        guard profile.lastOpenedDate != today else { return }
...
struct ContentView: View {
    ...
    var body: some View {
        ...
        .environment(\.theme, DesignSystem.ThemeColors(isDark: themeManager.isDark))
